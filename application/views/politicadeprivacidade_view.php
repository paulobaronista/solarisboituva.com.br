    ...
    <div class="container politica-info">
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-10 col-md-offset-1">
                <p>Nós da empresa CHALET EMPREENDIMENTOS IMOBILIARIOS SPE LTDA, respeitamos a privacidade de todos os nossos clientes, colaboradores e parceiros, nosso objetivo é garantir a integridade das informações e resguardar a privacidade.</p>
                ...
                <p>Em caso de dúvidas sobre esta Política de Privacidade, entre em contato conosco no endereço de e-mail     <a href="mailto:chalet.liana@uol.com.br">chalet.liana@uol.com.br</a></p>
            </div>
        </div>
    </div>
</div>